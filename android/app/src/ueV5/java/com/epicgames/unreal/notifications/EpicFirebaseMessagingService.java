...
import static co.pokeum.example.LocalNotificationReceiver.KEY_LOCAL_NOTIFICATION_ACTION;
import static co.pokeum.example.LocalNotificationReceiver.KEY_LOCAL_NOTIFICATION_BODY;
import static co.pokeum.example.LocalNotificationReceiver.KEY_LOCAL_NOTIFICATION_ID;
import static co.pokeum.example.LocalNotificationReceiver.KEY_LOCAL_NOTIFICATION_TITLE;
import static co.pokeum.example.activity.Game.LocalNotificationGetID;
...
import co.pokeum.example.GameApplication;
import co.pokeum.example.LocalNotificationReceiver;
import co.pokeum.example.activity.GameActivity;

import co.pokeum.unreal.notifications.OnMessageReceivedListener;
import co.pokeum.unreal.notifications.OnTokenRefreshListener;
...
public class EpicFirebaseMessagingService extends FirebaseMessagingService {
    ...
    private final OnTokenRefreshListener onTokenRefreshListener = new OnTokenRefreshListener();
...
//			meta = new EpicFirebaseNotificationMeta();
        ...
        onMessageReceivedListener.onMessageReceived(messageData);
        return meta;
    }
    ...
    public void onNewToken(@NonNull String firebaseToken) {
        ...
        if (TextUtils.isEmpty(firebaseToken)) {
            ...
            onTokenRefreshListener.OnTokenRefresh(firebaseToken);
        }
    }
