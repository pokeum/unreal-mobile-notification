...
bool TypeConverter::ConvertString(JNIEnv *Env, jstring JavaObject, FString& CppObject)
{
	...
	CppObject = FString(UTF8_TO_TCHAR(UTFString));
...
bool TypeConverter::ConvertMap(JNIEnv *Env, jobject JavaObject, TMap<FString, FString>& CppObject)
{
	if (JavaObject == nullptr) { return false; }
